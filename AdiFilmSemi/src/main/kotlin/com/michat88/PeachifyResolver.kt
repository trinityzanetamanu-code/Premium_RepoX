 ...
 *
 * Ported verbatim from the Adicinemax21/AdiDrakor baseline which is already
 * confirmed runtime-working. Only the package declaration changed; all logic
 * is byte-for-byte identical to the frozen baseline.
 *
 * Entry point: [resolveFromTmdbId] builds the canonical embed URL from the
 * TMDB metadata already present in AdiFilmSemi.LinkData and delegates to the
 ...
 * diffed 1:1 against the frozen baselines.
 */
