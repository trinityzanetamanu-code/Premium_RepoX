...
/**
 * Peachify playback source, ported verbatim from Streamzy's PeachifyResolver.
 *
 * The /watch/...-based routing has been removed because Adicinemax21 already
 * knows TMDB id + season + episode from LinkData; the embed URL is therefore
 * built deterministically. All internal Peachify behaviour (API endpoints,
 * air/holly route fallback, HLS filter, label grouping, URL dedup, subtitle
 * parsing, Indonesian detection, error handling, CancellationException
 * rethrow) is preserved exactly as in the Streamzy baseline.
 *
 * Log marker prefix "STREAMZY_PEACHIFY|..." is intentionally kept identical
 * to the donor so behaviour can be diffed 1:1 in logcat.
 */
internal class PeachifyResolver(
    ...
    // ============================================================
    // STREAM RESOLUTION (unchanged from Streamzy baseline)
    // ============================================================
