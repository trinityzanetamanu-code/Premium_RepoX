 ...
 * ================== IDLIX SOURCE ==================
 *
 * Sumber tambahan untuk AdiDrakor. Katalog, detail, pencarian, dan metadata
 ...
 *
 * DIAGNOSTIK: filter logcat dengan tag "AdiDrakorIDX".
 *
 * Seluruh DTO sengaja nested di dalam object ini supaya nama seperti Cast dan
 * Genre tidak bentrok dengan data class TMDB milik AdiDrakor.
 */
object AdiDrakorIdlix {

    private const val IDX_TAG = "AdiDrakorIDX"
